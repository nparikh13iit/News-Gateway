...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Fragments> newsFragments;
    private Map<String, Source> sourceStore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sourceStore.isEmpty() && savedInstanceState == null)
            new Thread(new SourceRunnable(this, "")).start();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        new Thread(new SourceRunnable(this, item.getTitle().toString())).start();
    ...
    public void populateSourceAndCategory(List<String> newsCategories, List<Source> newsSources) {
    ...
    public void updateFragments(List<Article> articles) {
        ...
        for (int article = 0; article < articles.size(); article++) {
            newsFragments.add(Fragments.newInstance(articles.get(article), article, articles.size()));
        }
